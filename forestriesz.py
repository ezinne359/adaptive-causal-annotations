#######################################################
# Title: Batch Adaptive Annotations
# Authors: Ezinne Nwankwo, Lauri Goldkind, Angela Zhou
# Last updated: April 16, 2026
# Notes: Function adapted from the codebase of the following paper 
#   - Title: RieszNet and ForestRiesz: Automatic Debiased Machine Learning with Neural Nets and Random Forests (2021). Published in ICML
#   - Authors: Victor Chernozhukov, Whitney K. Newey, Victor Quintas-Martinez, Vasilis Syrgkanis
#   - Github:https://github.com/victor5as/RieszLearning/blob/main/README.md
######################################################
